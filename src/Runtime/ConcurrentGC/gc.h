...
namespace gc {
    ...
    protected:
        ...
        void thd_deactivate() {
            _active_thds.fetch_sub(1, std::memory_order_acq_rel);
            _active_thds.notify_all();
        }
        ...
        void _set_paused(tcb_handle* handle, detail::thd_state new_state);
    ...
    public:
        ...
        void phase2(tcb_handle* handle, bool wait_for_others);
